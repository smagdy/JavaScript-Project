...
/////////------move--------------//////
	...
	function moveSmall()
	{
		...
		for (var i = 0; i < smallFish.length; i++) {
			...
			if( parseInt(smallFish[i].style.left)>1050 || parseInt(smallFish[i].style.top)==300 || parseInt(smallFish[i].style.left)<200||parseInt(smallFish[i].style.top)<200)
			{
	...
	function moveMid()
	{
		...
		for (var i = 0;i< midFish.length; i++) {
			...
			if( parseInt(midFish[i].style.left)>1050 || parseInt(midFish[i].style.top)==300 || parseInt(midFish[i].style.left)<200||parseInt(midFish[i].style.top)<200)
			{
				console.log(smallFish[i].style.left);
				console.log(smallFish[i].style.top);
				game.removeChild(smallFish[i]);
				i--;
			}
		}
	...
	function moveBig()
	{
		...
		for (var i = 0;i< bigFish.length; i++) {
			...
			if( parseInt(bigFish[i].style.left)>1050 || parseInt(bigFish[i].style.top)==300 || parseInt(bigFish[i].style.left)<200||parseInt(bigFish[i].style.top)<200)
			{
